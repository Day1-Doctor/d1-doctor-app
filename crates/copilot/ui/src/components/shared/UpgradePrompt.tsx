...
const PRICING_URL = "https://day1.doctor/dashboard/pricing";
 ...
 *
 * Two actions:
 * - "Upgrade" opens the pricing page in the default browser.
 * - "Run with Dr. Bob only" closes the modal (caller should fallback to
 *   single-agent mode).
 */
